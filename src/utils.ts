...
export function decode_text (
        ...
        input: NonNullable<Parameters<typeof text_decoder['decode']>[0]>,
...
export function decode_rgba (str: string): U8Arr {
    ...
    const arr = Array
        ...
        .map(    modify(3, n => Number.isFinite(n) ? n : 1))
...
export function slice_buf_by_rgba (buf: U8Arr | ArrayBuffer) {
...
export function flat (x: U8Arr, ...xs: readonly U8Arr[]): U8Arr {
